...
def check_what_is_visible(sensors, debris_sma, debris_sizes, unseen_debris_vectors, debris_sat_vectors,
    ...
    for s in range(len(sensors)):
        debris_sat_dist = get_debris_sat_distance(debris_sat_vectors)
        ...
        debris_magnitudes = get_magnitudes(debris_sizes, earth_sun_vectors, debris_sat_vectors, debris_sat_dist, tofs)
        ...
        print('>> detection:', 'dist', 1 in distances, ' |  fov', 1 in FOV,
