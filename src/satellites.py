...
class Satellite():
    ...
    def __init__(self, sma, ecc=0*u.one, inc=0*u.deg, raan=0*u.deg, argp=0*u.deg,
                 nu=0*u.deg, timeline=None, epoch=None):

        self.sma, self.ecc, self.inc = sma, ecc, inc.to(u.rad)
