...
sat2_r, sat2_v = propagate(sat2.initial.x, sat2.initial.y, sat2.initial.z, sat2.initial.vx, sat2.initial.vy, sat2.initial.vz,
                           full_timeline, J2=True)
# print('sat1 r =', sat1_r.shape, ' |  sat1 v =', sat1_v.shape)

# Initializing sensors ----------------------------------------------------------

sensor1 = Sensor(direction_vector=[0,-1,0], fov=360*u.deg, max_dist=3000*u.km, limiting_magnitude=30,
                 sat_r=sat1_r, sat_v=sat1_v)
# print('sensor vector 1', sensor1.direction_vector_eci.shape)
sensor2 = Sensor(direction_vector=[0,-1,0], fov=360*u.deg, max_dist=3000*u.km, limiting_magnitude=30,
...
np.savetxt('seen counter.csv', np.array(seen_debris_counter, dtype=int))
print(total_seen_by_sensor)
np.savetxt('total seen by sensor.csv', total_seen_by_sensor)
